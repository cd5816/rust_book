...
This repo currently contains both the historical `chapter_N/` layout and a newer workspace-backed `examples/ch_*/*` layout.
...
For new workspace-backed example crates, use:

```bash
cargo new --vcs none examples/ch_x/foo
```
